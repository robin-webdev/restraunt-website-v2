    ...
    home: {
      ...
      menu: {
        ...
        items: [
          ...
          { cat: "Starters", name: "Cold Beet Soup", desc: "Chilled beetroot soup with kefir, cucumber, egg, and dill", price: "7.50" },
          { cat: "Starters", name: "Pumpkin Soup", desc: "Creamy roasted pumpkin soup with toasted seeds and herb oil", price: "8.00" },
          { cat: "Starters", name: "Smoked Sprat Toast", desc: "Dark rye toast topped with smoked sprats, pickled onion, and dill creme fraiche", price: "9.20" },
          ...
          { cat: "Mains", name: "Slow-Braised Beef Cheeks", desc: "Tender beef cheeks with celery root puree, roasted carrots, and juniper jus", price: "24.90" },
          { cat: "Mains", name: "Wild Mushroom Barley Risotto", desc: "Creamy pearl barley with forest mushrooms, aged cheese, and crispy herbs", price: "16.50" },
          ...
          { cat: "Traditional", name: "Cabbage Rolls", desc: "Slow-cooked cabbage leaves filled with pork and rice in a rich tomato cream sauce", price: "15.40" },
          { cat: "Traditional", name: "Potato Pancakes", desc: "Golden potato pancakes served with smoked bacon jam and cultured sour cream", price: "11.80" },
          ...
          { cat: "Desserts", name: "Honey Cake", desc: "Layered honey cake with burnt honey cream and berry glaze", price: "8.20" },
          { cat: "Desserts", name: "Curd Mousse", desc: "Light curd mousse with sea buckthorn sauce and oat crumble", price: "7.90" },
          { cat: "Drinks", name: "Kvass", desc: "Traditional lightly sparkling rye bread drink served chilled", price: "3.90" },
          { cat: "Drinks", name: "Birch Sap Spritz", desc: "Refreshing seasonal birch sap with mint, lemon, and sparkling water", price: "4.80" },
          { cat: "Drinks", name: "House Berry Mors", desc: "Homemade cranberry and blackcurrant fruit drink", price: "4.20" },
          { cat: "Drinks", name: "Latvian Herbal Tea", desc: "A pot of local herbal tea with meadow flowers and honey on the side", price: "4.50" },
        ],
      },
      about: {
        eyebrow: "Our Story",
    ...
    home: {
      ...
      menu: {
        ...
        items: [
          ...
          { cat: "Uzkodas", name: "Aukstā zupa", desc: "Aukstā biešu zupa ar kefīru, gurķi, olu un dillēm", price: "7.50" },
          { cat: "Uzkodas", name: "Ķirbju zupa", desc: "Krēmīga ķirbju zupa ar grauzdētām sēklām un garšaugu eļļu", price: "8.00" },
          { cat: "Uzkodas", name: "Rupjmaizes tosts ar brētliņām", desc: "Rupjmaizes grauzdiņš ar kūpinātām brētliņām, marinētiem sīpoliem un diļļu krēmu", price: "9.20" },
          ...
          { cat: "Pamatēdieni", name: "Lēni sautēti liellopa vaigi", desc: "Mīksti liellopa vaigi ar selerijas biezeni, ceptiem burkāniem un kadiķogu mērci", price: "24.90" },
          { cat: "Pamatēdieni", name: "Meža sēņu grūbu risoto", desc: "Krēmīgi grūbu putraimi ar meža sēnēm, izturētu sieru un kraukšķīgiem garšaugiem", price: "16.50" },
          ...
          { cat: "Tradicionālie", name: "Kāpostu tīteņi", desc: "Lēni gatavoti kāpostu tīteņi ar cūkgaļu, rīsiem un tomātu krējuma mērci", price: "15.40" },
          { cat: "Tradicionālie", name: "Kartupeļu pankūkas", desc: "Zeltainas kartupeļu pankūkas ar kūpināta speķa ievārījumu un skābo krējumu", price: "11.80" },
          ...
          { cat: "Deserti", name: "Medus kūka", desc: "Kārtaina medus kūka ar karamelizētu medus krēmu un ogu glazūru", price: "8.20" },
          { cat: "Deserti", name: "Biezpiena putas", desc: "Gaisīgas biezpiena putas ar smiltsērkšķu mērci un auzu drumstalām", price: "7.90" },
          { cat: "Dzērieni", name: "Kvass", desc: "Tradicionāls viegli dzirkstošs rupjmaizes dzēriens, pasniegts atdzesēts", price: "3.90" },
          { cat: "Dzērieni", name: "Bērzu sulu spritz", desc: "Atsvaidzinošas bērzu sulas ar piparmētru, citronu un gāzētu ūdeni", price: "4.80" },
          { cat: "Dzērieni", name: "Mājas ogu morss", desc: "Pašgatavots dzēriens no dzērvenēm un upenēm", price: "4.20" },
          { cat: "Dzērieni", name: "Latvijas zāļu tēja", desc: "Tējkanna ar vietējo zāļu tēju, pļavas ziediem un medu atsevišķi", price: "4.50" },
        ],
      },
      about: {
        eyebrow: "Mūsu stāsts",
    ...
    home: {
      ...
      menu: {
        ...
        items: [
          ...
          { cat: "Закуски", name: "Холодный свекольник", desc: "Холодный суп из свеклы с кефиром, огурцом, яйцом и укропом", price: "7.50" },
          { cat: "Закуски", name: "Тыквенный суп", desc: "Нежный крем-суп из тыквы с поджаренными семечками и травяным маслом", price: "8.00" },
          { cat: "Закуски", name: "Ржаной тост со шпротами", desc: "Тост из темного ржаного хлеба со шпротами, маринованным луком и укропным кремом", price: "9.20" },
          ...
          { cat: "Основные", name: "Томленые говяжьи щечки", desc: "Нежные говяжьи щечки с пюре из сельдерея, запеченной морковью и можжевеловым соусом", price: "24.90" },
          { cat: "Основные", name: "Перловое ризотто с лесными грибами", desc: "Сливочная перловка с лесными грибами, выдержанным сыром и хрустящими травами", price: "16.50" },
          ...
          { cat: "Традиционные", name: "Голубцы", desc: "Томленые капустные рулеты со свининой, рисом и томатно-сливочным соусом", price: "15.40" },
          { cat: "Традиционные", name: "Картофельные оладьи", desc: "Золотистые картофельные оладьи с джемом из копченого шпика и сметаной", price: "11.80" },
          ...
          { cat: "Десерты", name: "Медовик", desc: "Слоеный медовый торт с карамелизированным медовым кремом и ягодной глазурью", price: "8.20" },
          { cat: "Десерты", name: "Творожный мусс", desc: "Легкий творожный мусс с соусом из облепихи и овсяной крошкой", price: "7.90" },
          { cat: "Напитки", name: "Квас", desc: "Традиционный слегка игристый напиток из ржаного хлеба, подается охлажденным", price: "3.90" },
          { cat: "Напитки", name: "Спритц из березового сока", desc: "Освежающий напиток из березового сока с мятой, лимоном и газированной водой", price: "4.80" },
          { cat: "Напитки", name: "Домашний ягодный морс", desc: "Домашний морс из клюквы и черной смородины", price: "4.20" },
          { cat: "Напитки", name: "Латвийский травяной чай", desc: "Чайник местного травяного чая с луговыми цветами и медом отдельно", price: "4.50" },
        ],
      },
      about: {
